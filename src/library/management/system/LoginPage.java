...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("D:\\images\\Stack-of-books6 - Copy.jpg")); // NOI18N
   ...
   try { 
     ...
     ResultSet rs = statement.executeQuery("select * from admin where name='"+uname+"' and password='"+pword+"'");
